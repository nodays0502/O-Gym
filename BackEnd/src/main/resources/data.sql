...
('A little progress each day adds up to big result','유산소운동',450000,4.0,25),
('MAKE TODAY A SUCCESSFUL DAY.','프리웨이트',230000,4.0,25),
('PUT YOUR HEART AND SOUL INTO IT AND TRAIN HARDER THAN YESTERDAY','코어강화',670000,4.2,25),
('The Pain you feel today will be the strength you feel tomorrow','힙업/바스트업',450000,2.9,25),
('Push yourself because no one else is going to do it for you.','자세개선',650000,4.0,25),
('Good things come to those who hustle','유연성강화',600000,2.4,25),
('Some people want to it happen, some wish it would happen, others make it happen','지방연소',300000,4.1,25),
('나는 오늘부터 달라지기로 결심했다','플라잉요가',500000,3.6,25),
('Start where you are. Use What you have. Do what you can','크로스핏',500000,3.6,25),
('오래된 습관을 바꾸는 것은 결코 늦지 않았습니다','자세교정',500000,4.1,25),
('몸부림 치는것은 괜찮지만, 꿈을 포기하는 것은 괜찮지 않습니다','보디빌딩',500000,3.7,25),
('완벽이 아닌 노력의 문제이다. 매일의 노력은 변화를 만든다.','마사지/통증완화',500000,3.2,25),
('힘든 시간은 당신을 더 강하게 만들겁니다.','스트레칭/생활근육',400000,3.4,25),
('I have failed over and over and over again in my life, And that is why I succeed','크로스핏',270000,4.0,25),
('꿈을 실현시키기 위해서는 엄청난 결단력, 헌신, 자기수양과 노력이 필요합니다','유연성강화',330000,4.0,25),
('아무것도 바꾸지 않으면 변하는 것은 없다','필라테스',300000,4.0,25),
('스쿼트를 열심히 하는 자에게 복이 있나니','자세교정',500000,3.9,25),
('균형잡힌 식생활이란 양 손에 든 초콜렛이다','보디빌딩',400000,3.5,25),
('당신의 몸에 귀를 기울이세요','마사지/통증완화',200000,3.2,25),
('당신이 아무리 천천히 걷고 있다 해도 쇼파에 엉덩이 붙이고 있는 사람들보다는 낫다!','지방연소/유산소운동',500000,4.0,25);
