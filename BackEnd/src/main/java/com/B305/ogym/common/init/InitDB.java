...
//        // initService 메서드 수행
//        initService.putAuth();
//        initService.putPTStudent1();
//        initService.putPTStudent2();
...
//                .build();
//
//            ptStudent.addMonthly(1, 160, 44);
//            ptStudent.addMonthly(2, 160, 43);
...
//        }
//
//        public void putPTStudent2() {
//
//            Address address = Address.builder()
//                .zipCode("62218")
//                .street("광주광역시 광산구 하남산단 6번로 107")
//                .detailedAddress("싸피 사무국")
//                .build();
//
//            List<PTStudentPTTeacher> teachers = new ArrayList<>();
...
//                .build();
//
//            ptStudent.addMonthly(4, 164, 51);
//            ptStudent.addMonthly(5, 164, 46);
//            ptStudent.addMonthly(6, 164, 45);
//            ptStudent.addMonthly(9, 164, 49);
//            ptStudent.addMonthly(10, 163, 48);
//            ptStudent.addMonthly(11, 164, 47);
//
//            em.persist(ptStudent);
//
//        }
...
//
//            Sns sns1 = Sns.builder().platform("instagram").ptTeacher(ptTeacher).url("instagram.com/physical_gallery_egg").build();
//            Sns sns2 = Sns.builder().platform("facebook").ptTeacher(ptTeacher).url("@egg-kim").build();
//            Sns sns3 = Sns.builder().platform("youtube").ptTeacher(ptTeacher).url("youtube.com/channel/UCdtRAcd3L_UpV4tMXCw63NQ").build();
//
//            ptTeacher.addSns(sns1);
//            ptTeacher.addSns(sns2);
//            ptTeacher.addSns(sns3);
//
