...
public class PageDeserializer extends JsonDeserializer<Page<?>> implements ContextualDeserializer {
    ...
    public Page<?> deserialize(JsonParser p, DeserializationContext ctxt)
        ...
        return new RestResponsePage<>(list, PageRequest.of(pageNumber, pageSize), total);
    }

    /**
     * This is the main point here. The PageDeserializer is created for each specific
     * deserialization with concrete generic parameter type of Page.
     */
    @Override
